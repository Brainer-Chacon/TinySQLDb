...
using Entities; // Asegúrate de incluir este espacio de nombres
...
namespace ApiInterface
{
    ...
    public class Server
    {
        ...
        {
            var request = new Request("Error processing request", RequestType.SQLSentence);
            var errorResponse = new Response(request, OperationStatus.Error, reason); // Asegúrate de usar el constructor
            SendResponse(errorResponse, handler);
